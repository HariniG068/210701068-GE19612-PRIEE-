		...
		<div class="description-container"  >
			<div class="box1">
				<?php
					...
					{
				?>
				<img src="<?php echo $rows['pi_main']; ?>" alt="Taj Mahal Image" style="width: auto;height: 270px; margin-top:40px;">
			</div>
			...
			<a href="booking.html" style="top: -20px; float: right; margin-right: 280px;">Book Tour</a>
		</div>
